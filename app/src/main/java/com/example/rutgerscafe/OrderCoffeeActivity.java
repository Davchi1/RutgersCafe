...
public class OrderCoffeeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        submit_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (coffeeSize.equals("No size") || Quantity.equals("0")) {
                    ...
                    Toast.makeText(getApplicationContext(), "You've succesfully added " + myCoffee.toString() + " to your order", Toast.LENGTH_SHORT).show();
    ...
    /**
     * Calculates the total for the Coffee given all the information
     */
    ...
    /**
     * When a quantity is changed, dynamically updates the total
     * @param parent
     * @param view
     * @param position
     * @param id
